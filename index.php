...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-image: url('img/navground.png');">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li style="margin-top: 2%; ">
					<form class="form-inline my-2 my-lg-0">
						<input class="form-control mr-sm-2" type="text" name="keyword" style="width: 500px; border-radius: 30px;" placeholder="Search" aria-label="Search">
					</form>
				</li>
			...
			<img src="icon/notification.png" alt="" style="width: 35px; position: absolute; right: 415px; top: 30px;">
			<img src="icon/add-to-cart.png" alt="" style="width: 35px; position: absolute; right: 365px; top: 30px;">
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" ">
		...
		<div class="carousel-inner" style="width: 700px; height: 300px; left: 150px; top: 30px;">
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" ">
		...
		<div class="carousel-inner" style="width: 300px; height: 200px; right: 100px ; top: -270px; position: absolute; right: 200px; ">
			<div class="carousel-item active">
				<img src="img/1.png" class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
