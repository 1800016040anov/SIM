...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: aliceblue; margin-top: 30px; margin-left: 15px;">
            Kategori
          </a>
        ...
        <li>
          <form class="form-inline my-2 my-lg-0">
            <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" style="right: 50%; width: 500px;  margin-top: 30px; border-radius: 35px;">
          </form>
        </li>
        ...
        <li style="background-color: aquamarine; height: 50%; border-radius: 5px;padding-left: 20px; padding-right: 20px; margin-left: 40px; margin-top: 35px;">
  ...
  <div class="inner-container container no-padding ng-star-inserted" id="cart-area">
    ...
    <div class="col-md-8 no-padding wraping-summary ng-star-inserted" id="cart-container">
      ...
      <div class="display-product">
        <p class="no-margin"> Menampilkan
          <span class="display-product-bold"><b> 1 Produk </b></span> dalam Keranjang </p>
      </div>
                ...
                <div class="col-sm-6 no-padding sticky-sidebar ng-star-inserted" id="tambah">
                  ...
                  <table id="table2">
                    <tr>
                      ...
                      <th><input class="summary-qty-material-input ng-untouched ng-pristine ng-valid ng-star-inserted" gmonlynumber="true">
                        <!---->
                      </th>
  ...
  <!-- Section Footer -->
  <div class="footer">
    <div class="container mt-5" style="background-color: rgb(230, 228, 228); padding:10px;">
